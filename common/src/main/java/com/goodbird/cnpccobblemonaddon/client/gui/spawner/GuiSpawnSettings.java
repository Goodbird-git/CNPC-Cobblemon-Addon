...
public class GuiSpawnSettings extends GuiBasePokemon implements IGuiData {
    ...
    public void init() {
        ...
        ((GuiFixedTextFieldNop)getTextField(2)).setFGColor(0x854a13);
        ...
        ((GuiFixedTextFieldNop)getTextField(3)).setFGColor(0x854a13);
        ...
        ((GuiFixedTextFieldNop)getTextField(4)).setFGColor(0x854a13);
        ...
        ((GuiFixedTextFieldNop)getTextField(5)).setFGColor(0x854a13);
        ...
        ((GuiFixedTextFieldNop)getTextField(6)).setFGColor(0x854a13);
        ...
        ((GuiFixedTextFieldNop)getTextField(7)).setFGColor(0x854a13);
    ...
    public void save() {
        if (this.tile != null) {
            Packets.sendServer(new SPacketTileEntitySave(this.tile.saveWithFullMetadata(player.level().registryAccess())));
        }
    }

    public void setGuiData(CompoundTag compound) {
        this.tile.loadAdditional(compound, player.level().registryAccess());
        this.init();
    }
}