...
public class GuiSpawnerEntry extends GuiContainerBasePokemon<ContainerSpawnerEntry> implements IGuiData {
    ...
    public void init() {
        ...
        getTextField(0).listener = (f)-> data.setSpecies(ResourceLocation.parse(f.getValue()));
        ((GuiFixedTextFieldNop)getTextField(0)).setFGColor(0x854a13);
        ...
        ((GuiFixedTextFieldNop)getTextField(1)).setFGColor(0x854a13);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            ((GuiFixedTextFieldNop)this.getTextField(27 + i)).setFGColor(0x854a13);
